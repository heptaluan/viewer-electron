...
class StandaloneRouting extends Component {
  ...
  async componentDidMount() {
    try {
      ...
      let { server, studies, studyInstanceUIDs, seriesInstanceUIDs } = await this.parseQueryAndRetrieveDICOMWebData(
        query
      )

      if (studies) {
        const { studies: updatedStudies, studyInstanceUIDs: updatedStudiesInstanceUIDs } =
